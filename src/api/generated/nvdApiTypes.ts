 ...
 * CVSS subscore.
 */
export type DefSubscore = number;

export interface JSONSchemaForNVDVulnerabilityDataAPIVersion222 {
...
export interface CveItem {
  ...
  cveTags?: {
     ...
     */
    sourceIdentifier?: string;
    tags?: ("unsupported-when-assigned" | "exclusively-hosted-service" | "disputed")[];
    [k: string]: unknown;
  }[];
  /**
   * @minItems 1
   */
  descriptions: [LangString, ...LangString[]];
...
export interface CvssV40 {
  ...
  cvssData: JSONSchemaForCommonVulnerabilityScoringSystemVersion40;
}
export interface CvssV31 {
  source: string;
  type: "Primary" | "Secondary";
  cvssData: JSONSchemaForCommonVulnerabilityScoringSystemVersion31;
  exploitabilityScore?: DefSubscore;
  impactScore?: DefSubscore;
}
...
export interface CvssV30 {
  source: string;
  type: "Primary" | "Secondary";
  cvssData: JSONSchemaForCommonVulnerabilityScoringSystemVersion30;
  exploitabilityScore?: DefSubscore;
  impactScore?: DefSubscore;
}
...
export interface CvssV2 {
  source: string;
  type: "Primary" | "Secondary";
  cvssData: JSONSchemaForCommonVulnerabilityScoringSystemVersion20;
  baseSeverity?: string;
  exploitabilityScore?: DefSubscore;
  impactScore?: DefSubscore;
  acInsufInfo?: boolean;
